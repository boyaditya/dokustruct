...
function paddleClsPreprocess(img, resizeShort = 256, cropSize = 224) {
  ...
  // Parity: keep BGR — model trained against BGR-input; do not convert.
...
function qanythingClsPreprocess(img, cropSize = 224) {
  ...
  try {
    ...
    // Parity: INTENTIONAL R/B swap in luminance — matches Python training distribution. do not revert.
    ...
    // Parity: INTER_CUBIC matches Pillow ≥9.1 default BICUBIC interpolation used in Python
