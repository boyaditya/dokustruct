...
export class AppState {
  ...
  get ocrConfig() {
    ...
    return {
      ...
      // Conservative WebGPU rec batch. Higher values squeeze more parallelism
      // out of high-end GPUs but increase per-batch input + output buffer
      // size. On lower-end GPUs the larger buffers can exceed the driver's
      // per-allocation limits and trip a lost-device. The chosen value is a
